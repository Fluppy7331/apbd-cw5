...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var tempList = depts.Where(e => e.Loc == "CHICAGO").Select(d => d.DeptNo).ToList();
        var result = emps.Where(e => tempList.Contains(e.DeptNo)).ToList();
    ...
    public void ShouldCountEmployeesPerDepartment()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(finalForm => new
        {
            DeptNo = finalForm.Key,
            Count = finalForm.Count()
        });
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps
            ...
            .Select(final => new { final.e.EName, final.s.Grade }) 
            .ToList();
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps.GroupBy(e => e.DeptNo).Select(final => new
        {
            DeptNo = final.Key,
            AvgSal = final.Average(e => e.Sal)
        });
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => e.Sal > emps.Where(inEmp => inEmp.DeptNo == e.DeptNo).Average(inEmp => inEmp.Sal))
